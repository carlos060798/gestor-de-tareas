...
export default function TaskModalDetails({ task, closeTaskModal }: DataValues) {
 ...
 /* return (
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50 p-4 md:p-8">
      <div className="w-full max-w-lg max-h-[90vh] bg-white rounded-lg shadow-lg p-6 md:p-8 relative overflow-y-auto">
        <button
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50 p-4 md:p-8">
      <div className="w-full max-w-xl max-h-[90vh] bg-white rounded-lg shadow-lg p-6 md:p-8 relative overflow-y-auto">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div>
            <h3 className="text-xl font-bold">Crear Tarea</h3>
            {/* Tu componente para crear tareas aquí */}
          </div>
          <div>
            <h3 className="text-xl font-bold">Notas</h3>
            <NoteViuws projectid={projectid} taskid={taskid} />
...
/*export default function TaskModalDetails({ task, closeTaskModal }: DataValues) {
  ...
  return (
    <Fragment>
      <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 z-50 p-4 md:p-8">
        <div className="w-full max-w-5xl bg-white rounded-lg shadow-lg p-6 md:p-8 relative">
          <button
            className="absolute top-4 right-4 text-gray-500 hover:text-gray-800 focus:outline-none"
            onClick={closeTaskModal}
            aria-label="Close"
